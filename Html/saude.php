...
<!-- CONTEUDO -->
<section id="breadcrumb" class="bg-bc-white">
	<div class="container">
		<ol class="breadcrumb">
...
<div id="bg-saude-inner"></div>

<section id="banner-inner">
	<div class="container">
		<img class="img-responsive" src="../images/banner-saude.png" />
	</div>
</section>

<section id="rede-credenciada">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4 btn-footer">
				<a href="" class="bg-btn-radius btn-blue-light ">
					...
					<div class="btn-text">
						<p>
							Encontre os <br>
							<span>profissionais<br> 
								e locais</span> que podem <br>
								atender você.
							</p>
						</div>
					</a>
	...
	<section id="planos">
		<div class="container">
			<div class="title-info">
				<h2>Conheça os <span>nossos planos</span></h2>
			</div>
			<div class="row">
				<div class="col-lg-4">
